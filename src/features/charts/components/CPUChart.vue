  ...
  <div class="chart-card">
    <div class="chart-header">
      <div class="title-group">
        ...
        <p class="subtitle">Live processing load</p>
      </div>
      <div class="stat">
...
const avgCpu = computed(() => {
  if (!cpuSeries.value.values.length) return 0
  const sum = cpuSeries.value.values.reduce((a, b) => a + b, 0)
  return Math.round(sum / cpuSeries.value.values.length)
})
